...
router.get('/', auth.hasRole('admin') || auth.hasRole('teacher'), controller.index); // admin, get users
...
router.put('/:id/admin', auth.hasRole('admin') || auth.hasRole('teacher'), controller.upsert); // admin, update existing user
